  ...
  return (
    <div>
        <div ref={reference.raf} id='titledev' className=' leading-none max-[540px]:leading-10 '>
            <h1 className=' text-[4.2vw] max-[767px]:text-[8vw] font-bold font-[anzo2] text-base/10 '>I AM <span className='text-zinc-500 pl-5! font-extrabold font-[anzo3]'> ABDUL MATEEN </span></h1>
