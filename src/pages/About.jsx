            ...
            gsap.fromTo(element,
                ...
                },
                {
                    ...
                    scrollTrigger: {
                        trigger: element,
                        start: "top 50%",
                        toggleActions: "play reverse play reverse", // play when in, reverse when out
                        markers: false
                    }
                }
            );
...
// }, []);
  ...
  return (
    <>
    <div id='About' ref={refec} className='h-screen  mt-[60px]! p-4! max-[540px]:p-3!'>
